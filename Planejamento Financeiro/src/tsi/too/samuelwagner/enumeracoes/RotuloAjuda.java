...
public enum RotuloAjuda {
	 ...
	 */
	CADASTRO_DESPESA("Para cadastrar uma despesa, basta ir até a aba Despesas na janela principal, e clicar no botão Cadastrar."
	 ...
	 */
	VISUALIZAR_DESPESA("Para visualizar uma despesa, basta ir até a aba Despesas na janela principal, e clicar no botão Detalhes."
	 ...
	 */
	VISUALIZAR_META("Para visualizar uma meta, basta ir até a aba Metas na janela principal, e selecionar o mês que "
	 ...
	 */
	CADASTRAR_META("Para cadastrar uma meta, basta ir até a aba Metas na janela principal, e clicar no botão Metas."
	 ...
	 */
	CADASTRAR_RENDA("Para cadastrar uma renda, basta ir até a aba Rendas na janela principal, e clicar no botão Cadastrar."
	...
	VISUALIZAR_GRAFICO("Existem quatro gráficos específicos que podem ser gerados. São eles: Gráfico de Metas, Categorias, "
			+ "Formas de pagamento e Balanço mensal. Os três últimos podem ser acessados através da aba Balanço Mensal, onde existe um"
			+ " botão relativo a cada gráfico, e o primeiro gráfico citado, pode ser acessado na aba de Metas onde existe um botão Visão Gráfica. "
			+ "Eles também podem ser acessados através do painel principal, na aba de acesso rápido."),
	/**
