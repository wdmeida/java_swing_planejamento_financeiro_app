...
/**
 * Define as funções responsáveis por salvar e recuperar um objeto <code>Categoria</code> persistido em um arquivo no disco.
 * 
 * @author Samuel e Wagner
 */

public class ArquivoCategoria extends ArquivoBinario {
	 ...
	 * 
	 * @return um <code>Categoria</code> com os dados lidos do arquivo.
	 */
	@Override
	public Categoria readObject() throws IOException {
		Categoria categoria = new Categoria();
		
		categoria.setCodigo(arquivoBinario.readInt());
		categoria.setDescricao(readString(30, true));
	...
	public void writeObject(Object obj) throws IOException, ClassCastException {
		...
		arquivoBinario.writeInt(categoria.getCodigo());
		
		arquivoBinario.writeChars(setStringLength(categoria.getDescricao(), 30));

	}//writeObject()

}//class ArquivoCategoria
